...
export default (state = defaultState, action) => {
  ...
  switch (action.type) {
    ...
    case REMOVE_TICKET:
      let fewer_tickets = state.currentUser.tickets.filter(ticket => ticket.id !== action.ticket.id);
      let new_user_with_fewer_tickets = Object.assign( {}, state.currentUser, {tickets: fewer_tickets} );
