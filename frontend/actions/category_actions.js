...
export const createCategoryMembership = categoryMemberhip => dispatch =>
	APIUtil.createCategoryMembership(categoryMemberhip).then(
		categoryMembership => dispatch(fetchCategories(categoryMembership)),
		errors => dispatch(receiveErrors(errors.responseJSON))
	);

export const removeCategoryMembership = eventId => dispatch =>
	APIUtil.removeMembership(eventId).then(
		categoryMembership => dispatch(fetchCategories(categoryMembership)),
		errors => dispatch(receiveErrors(errors.responseJSON))
	);
