...
class EventShow extends React.Component {
	...
	render() {
		if (this.props.event !== undefined) {
			...
			const ticketModal = this.props.ticketingModalActive ? (
				<TicketPurchaseModal
			...
			return (
				<div className="event-show-container-marginfix">
					<div>
						<div className="event-show-background" style={eventImage} />
					</div>

					<div className="event-show-background-boundary" />
					<article className="event-show-container">
						<header className="event-show-hero">
							<figure className="event-show-hero-image" style={eventImage} />
							<figcaption className="event-show-hero-info-container">
								<div>
									<span className="event-show-hero-date-sm">{startMonth}</span>
									<br />
									<span className="event-show-hero-date-lg">{startDay}</span>
									<br />
									<br />
									<span className="event-show-hero-title">{title}</span>
								</div>
								<div className="event-show-hero-price">${formattedPrice}</div>
							</figcaption>
						</header>

						<section className="event-show-CTA-container">
							<button
								className="event-show-CTA-bookmark"
								onClick={this.changeBookmark}>
								{bookmarkIcon}
							</button>
							<button
								className="event-show-CTA-button callback-fill"
						...
						<section className="event-show-body-container">
							<article className="event-show-body-description">
								...
								<div className="event-show-category">{categories}</div>
							</article>
