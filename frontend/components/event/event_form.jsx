	...
	updateFile() {
		return e => {
			...
			if (file) {
				...
				this.setState({
					eventShowUrl:
						'https://s3.amazonaws.com/sideshow-development/Screen+Shot+2018-01-10+at+5.09.04+PM.png'
				});
			}
		};
	}
	...
	render() {
		if (this.props.event === {} || this.state === null) {
			...
			if (this.state.imageUrl) {
				...
				uploadedImage = {
					backgroundImage: 'url(' + this.state.event_show_image_url + ')'
				};
			}
			...
			return (
				<section className="event-form-container">
					<form className="event-form">
						...
						<section className="event-form-datetime-row">
							<div className="event-form-datetime-container">
								...
								<Flatpickr
									...
									onChange={event_start => {
										this.setState({ event_start });
									}}
									options={{
										dateFormat: 'M j, h:iK',
										altFormat: 'M j, h:iK',
						...
						<textarea
							className="event-form-rich-text"
