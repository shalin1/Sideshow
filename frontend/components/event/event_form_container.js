	...
	if (ownProps.match.path === '/create') {
		...
		eventData = {
			...
			event_show_image_url:
				'https://s3.amazonaws.com/sideshow-development/Screen+Shot+2018-01-10+at+7.20.36+PM.png'
		};
	} else {
...
const mapDispatchToProps = (dispatch, ownProps) => {
	...
	return {
		...
		createCategoryMembership: membership =>
			dispatch(createCategoryMembership(membership))
	};
};
