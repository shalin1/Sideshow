...
class SignInForm extends React.Component {
	...
	handleDemoLogin(e) {
		e.preventDefault();
		const demoUser = {
			user: { email: 'demo@gmail.com', password: 'password' }
		};
			...
			<div className="session-form-container">
				<section className="login-modal-CTA">
					<div className="login-icon-container">
						<i
							className="fa fa-bullhorn fa-2x fa-spin login-icon"
							aria-hidden="true"
						/>
					</div>
					<br />
				...
				<form onSubmit={this.handleSubmit}>
					...
					<div className="form-input-box">
						...
						/>
						<br />
						<button disabled={buttonDisabled} className="session-action-button">
							Get Started
						</button>
						<br />
						<button
