		...
		if (this.props.formType === 'Login') {
				...
				<section className="login-modal-CTA">
					<div className="login-modal-CTA">
						<div className="login-icon-container">
							<i className="fa fa-user fa-3x login-icon" aria-hidden="true" />
						</div>
						<br />
						<h3 className="user-prompt-medium">Welcome back</h3>
						<h4 className="user-prompt-small">
			...
			return (
				<section className="login-modal-CTA">
					<div className="login-icon-container {}">
						<i
							className="fa fa-user fa-3x login-icon"
							aria-hidden="true"
							color="grey"
						/>
					</div>
		...
		return (
			<div className="session-form-container">
				...
				<form onSubmit={this.handleSubmit}>
					...
					<button onClick={this.handleSubmit} className="session-action-button">
						Log In
					</button>
				</form>
			</div>
